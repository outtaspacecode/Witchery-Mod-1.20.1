...
public class WitchCauldronRecipe implements Recipe<SimpleContainer> {
    ...
    public WitchCauldronRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> inputItems) {
    ...
    public static class Type implements RecipeType<WitchCauldronRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "witch_cauldron";
    }

    public static class Serializer implements RecipeSerializer<WitchCauldronRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(WitcheryMod.MOD_ID, "witch_cauldron");
        ...
        public WitchCauldronRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new WitchCauldronRecipe(id, output, inputs);
        }

        @Override
        public @Nullable WitchCauldronRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, WitchCauldronRecipe recipe) {
