...
public class DistilleryMenu extends AbstractContainerMenu {
    ...
    public DistilleryMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 48, 54));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 48, 16));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 48, 34));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 110, 16));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 128, 16));
            this.addSlot(new SlotItemHandler(iItemHandler, 5, 110, 34));
            this.addSlot(new SlotItemHandler(iItemHandler, 6, 128, 34));
